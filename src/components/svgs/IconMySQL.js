...
const IconMySQL = props => {
  return (
    <svg
      ...
      {...props}
    >
      <path fill="url(#pattern0)" d="M0 0H176V119H0z"></path>
      <defs>
        <pattern
          id="pattern0"
          width="1"
